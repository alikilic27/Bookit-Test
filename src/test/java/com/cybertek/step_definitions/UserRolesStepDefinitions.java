...
public class UserRolesStepDefinitions {
    ...
    public void the_user_logs_in_as_a_light_side_team_member() {
        ...
        UserUtility.getUserCredentials(ApplicationConstants.STUDENT_TEAM_MEMBER, ApplicationConstants.LIGHT_SIDE);
    ...
    public void the_user_logs_in_as_a_light_side_team_lead() {
        ...
        SignInPage signInPage = new SignInPage();
        Map<String, String> userCredentials =
                UserUtility.getUserCredentials(ApplicationConstants.STUDENT_TEAM_LEADER, ApplicationConstants.LIGHT_SIDE);
        signInPage.login(userCredentials.get("email"), userCredentials.get("password"));
    }
    ...
    public void the_user_logs_in_as_a_light_side_teacher() {
        ...
        SignInPage signInPage = new SignInPage();
        Map<String, String> userCredentials =
                UserUtility.getUserCredentials(ApplicationConstants.TEACHER, ApplicationConstants.LIGHT_SIDE);
        signInPage.login(userCredentials.get("email"), userCredentials.get("password"));
    }
}
